...
from domain.wp_config import OVERWRITE_FILE, TAGS_EN, MARGIN_DATE, COOKIES, HEADERS # импорт конфигурационного файла
from Wattpad.selectors.selectors import SELECTORS

class WattpadRepliesSpiderEN(scrapy.Spider):
    name = "WattpadParserEN_replies"
    ...
    def start_requests(self, tags=TAGS_EN):
    ...
    def parse(self, response):
        ...
        ajax_url = f'https://api.wattpad.com/v5/hotlist?tags={genre}&language=1&offset=0&limit=20'
    ...
    def parse_chapters_links(self, response):
        ...
        book_data['read_time'] = response.css(SELECTORS['readTime'])[3].get()
        ...
        for chapter in chapters:
            ...
            chapters_info.append({'name': name,
                                  'link': link,
        ...
        if chapters_info[-1]['publication_date'] < self.margin_date: # если последняя глава книги
    ...
    def parse_chapter_meta(self, response):
        ...
        #with open(f'ttt{ch_indx}.txt', 'w', encoding='utf8') as f:
